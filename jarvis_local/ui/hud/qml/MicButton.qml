...
Item {
    ...
    implicitWidth: Design.sp(9)
    implicitHeight: Design.sp(9)

    readonly property color _c: micState === "denied" ? Design.alert
        : micState === "listening" ? Design.cyan : Design.textSecondary

    Rectangle {
        anchors.fill: parent
        radius: Design.radiusHud
        color: micState === "listening" ? Design.glow(Design.cyan, 0.12)
             : hover.hovered && micState !== "denied" ? Qt.rgba(1, 1, 1, 0.04)
             : "transparent"
        border.width: 1
    ...
    Canvas {
        ...
        width: Design.sp(5); height: Design.sp(6)
        onPaint: {
