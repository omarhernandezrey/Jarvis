...
_ALIAS = {
    ...
    "volume_set": "controlar_volumen",
    "volume_up": "controlar_volumen",
    "volume_down": "controlar_volumen",
    "volume_mute": "controlar_volumen",
    "media_play_pause": "controlar_musica",
    "media_next": "controlar_musica",
    "media_previous": "controlar_musica",
    ...
    "add_contact": "enviar_whatsapp",
    "list_contacts": "enviar_whatsapp",
    "daily_briefing": "resumen_del_dia",
    "minimize_all": "organizar_ventanas",
    "snap_window": "organizar_ventanas",
    "read_clipboard": "leer_portapapeles",
    "read_file": "leer_archivo",
    "lock_pc": "energia_del_equipo",
    "shutdown_pc": "energia_del_equipo",
    "restart_pc": "energia_del_equipo",
    "cancel_shutdown": "energia_del_equipo",
    "suspend_pc": "energia_del_equipo",
